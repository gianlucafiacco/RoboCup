...
#include "Tools/BufferCorrelationInTime.h"
...
STREAMABLE(Teammate,
{
               ...
               //SPQR
               (RobotPoseSpqrFilteredCompressed) robotPoseSpqrFiltered, /**< Robot pose SPQR filtered */
               (SpqrDWKcombinerCompressed) spqrDWKcombination,          /**< Spqr world model combiner */
               (GlobalBallEstimationCompressed) globalBallEstimation,   /**< global ball observations */
           });
...
{
               BufferCorrelationInTime coordinationBuffer;
