...
//~ #include "Representations/Modeling/Whistle.h" // TODO serve?
//~ 
...
//~ private:
  ...
  //~ RingBuffer<float, WHISTLE_BUFF_LEN> inputChannel2;
  //~ RingBuffer<float, WHISTLE_BUFF_LEN> inputChannel3;
  //~ 
  //~ int sent = 0;
  //~ 
...
//~ 
  ...
  //~ double compareTone(fftw_complex fftCmpData[], double& correlation);
  //~ /**
