...
void PenaltyMarkPerceptor::searchPotentialLineSpots(PenaltyMarkPercept& penaltyPoint)
{
    ...
    //Check for the penalty over all possible lines
...
/*
 * Check the position of the penalty mark
 */
...
//TODO DARIO stesso metodo che viene usato anche per la palla.
// Inserisci condizioni su non nero e non grigio per evitare che si riconosca la palla.
// Il white skipping potrebbe non essere sufficiente. Controlla!
// Forse e' possibile gestire  la cosa andando a controllare gli angoli del quadrato che racchiude il
// penalty. E' una croce. non deve avere bianco o nero in quelle posizioni mentre la palla si.
// Fai un check dove viene controllato il verde.
...
{
    // noiseAreaSize comes from the .h
    ...
    // not a penalty mark
    // TODO DARIO check the parameters inside, maybe they are too restrictive
...
//TODO DARIO questo va riscritto. Se la palla viene riconosciuta come penalty e' un casino!S
